...
struct Runvf: ParsableCommand {
    ...
    struct Options: ParsableArguments, VMConfig {
        @Option var memorySize: UInt64 = 512 * 1024 * 1024
        @Option var cpuCount: Int = 1
        
        func createConfig() -> VZVirtualMachineConfiguration {
    ...
    struct Boot: ParsableCommand, VMConfig {
        @OptionGroup var options: Options
        ...
        func createConfig() throws -> VZVirtualMachineConfiguration {
            ...
            let config = options.createConfig()
            ...
            if #available(macOS 13, *) {
                ...
                if #available(macOS 14, *) {
                    try? rosettaDirectoryShare.setCachingOptions(.abstractSocket("rosetta"))
                }
            }
